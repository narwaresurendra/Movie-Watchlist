          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              {message.type === 'success-undo' && lastAddedMovie && (
                <button
                  ...
                  className="px-3 py-1 bg-green-700 hover:bg-green-800 text-white rounded-lg text-xs font-medium transition-colors"
                >
                  Undo
                </button>
              )}
            ...
            {message.type === 'success-undo' && (
              <button
                ...
                className="w-full px-4 py-2 bg-white text-green-700 hover:bg-gray-50 rounded-lg text-sm font-medium transition-colors flex items-center justify-center space-x-2 border border-green-200"
              >
