          ...
          <div className="p-4">
            ...
            {message.type === 'success-undo' && (
              <button
                ...
                className="w-full px-4 py-2 bg-white text-green-600 hover:bg-gray-50 rounded-lg text-sm font-medium transition-colors flex items-center justify-center space-x-2"
              >
