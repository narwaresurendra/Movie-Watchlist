        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-12">
            <Link to="/" className="flex items-center space-x-3 group">
              <img
                src="/Gemini_Generated_Image_bmgpgfbmgpgfbmgp.png"
                alt="FilmFave Logo"
                className="w-10 h-10 transform transition-transform duration-300 group-hover:scale-110"
              />
              <div>
                <span className="text-xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent tracking-tight">
                  FILMFAVE
                </span>
                <p className="text-xs text-gray-500 -mt-1">Your Curated Watchlist</p>
              </div>
            </Link>
        ...
        <div className="md:hidden glass-effect border-t border-gray-200 animate-slide-down">
          <div className="section-container py-6 space-y-2">
            ...
            <Link
              to="/reviews"
              className={`block px-4 py-3 rounded-2xl text-base font-medium transition-colors ${
                isActive('/reviews') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-100'
              }`}
              onClick={() => setShowMobileMenu(false)}
            >
              <span className="flex items-center space-x-2">
